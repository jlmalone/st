package vision.salient.trisolaran.ui.compose.appbar
...
import vision.salient.trisolaran.ui.compose.menu.OverflowMenuItem
import vision.salient.trisolaran.ui.compose.menu.OverflowMenuItemsContent
...
sealed interface AppBarMenuItem {
    ...
    ) : AppBarMenuItem, vision.salient.trisolaran.ui.compose.menu.OverflowMenuItem.MenuItem(text, leadingIcon, trailingIcon, action) {
    ...
    class OverflowMenuItemCustom(
        ...
        override val action: () -> Unit
    ) : AppBarMenuItem, vision.salient.trisolaran.ui.compose.menu.OverflowMenuItem.MenuItemCustom(text, leadingContent, trailingContent, action) {
    ...
    object OverflowDivider : AppBarMenuItem, vision.salient.trisolaran.ui.compose.menu.OverflowMenuItem.Divider()
