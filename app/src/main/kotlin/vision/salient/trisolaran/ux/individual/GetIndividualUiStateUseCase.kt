...
import vision.salient.trisolaran.ui.compose.dialog.showMessageDialog
...
@Inject constructor(
    ...
    operator fun invoke(
        ...
        return IndividualUiState(
            ...
            individualFlow = vision.salient.trisolaran.util.ext.stateInDefault(coroutineScope, null),
