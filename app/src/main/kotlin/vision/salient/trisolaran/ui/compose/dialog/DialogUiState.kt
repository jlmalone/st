package vision.salient.trisolaran.ui.compose.dialog
...
import org.jdc.template.ui.compose.dialog.MenuOptionsDialogUiState
import org.jdc.template.ui.compose.dialog.MessageDialogUiState
import org.jdc.template.ui.compose.dialog.MultiSelectDialogUiState
import org.jdc.template.ui.compose.dialog.TwoInputDialogUiState
...
fun LibraryDialogs(dialogUiState: DialogUiState<*>) {
    when (dialogUiState) {
        ...
        is ProgressIndicatorDialogUiState -> vision.salient.trisolaran.ui.compose.dialog.ProgressIndicatorDialog(dialogUiState)
        ...
        is TimePickerDialogUiState -> vision.salient.trisolaran.ui.compose.dialog.TimePickerDialog(dialogUiState)
    }
}
